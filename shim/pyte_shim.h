...
#define PYTE_ENOPROTOOPT TE_ENOPROTOOPT
...
#define PYTE_SO_INCOMING_NAPI_ID RPC_SO_INCOMING_NAPI_ID
...
extern void pyte_step_push(const char *text);
extern void pyte_step_pop(const char *text);
...
#define PYTE_MI_MEAS_PPS        TE_MI_MEAS_PPS
