...
te_errno pyte_rpc_getsockname(rcf_rpc_server *rpcs, int s,
                              ...
                              int *out);
te_errno pyte_rpc_shutdown(rcf_rpc_server *rpcs, int s, int how, int *out);
te_errno pyte_rpc_getpeername(rcf_rpc_server *rpcs, int s,
                              struct sockaddr *name, socklen_t *namelen,
                              int *out);
te_errno pyte_rpc_getsockopt_int(rcf_rpc_server *rpcs, int s, int optname,
                                 int *value, int *out);
te_errno pyte_sock_set_blocking(rcf_rpc_server *rpcs, int s, int blocking,
                                int *out);
te_errno pyte_sock_get_blocking(rcf_rpc_server *rpcs, int s, int *blocking,
                                int *out);
...
#define PYTE_SO_REUSEPORT ...
#define PYTE_SO_KEEPALIVE ...
#define PYTE_SO_BROADCAST ...
#define PYTE_SO_RCVBUF ...
#define PYTE_SO_SNDBUF ...
#define PYTE_SO_ERROR ...
#define PYTE_SO_INCOMING_NAPI_ID ...
#define PYTE_TCP_NODELAY ...
#define PYTE_IP_PKTINFO   ...
#define PYTE_SHUT_RD ...
#define PYTE_SHUT_WR ...
#define PYTE_SHUT_RDWR ...
#define PYTE_MSG_OOB ...
#define PYTE_MSG_PEEK ...
#define PYTE_MSG_DONTROUTE ...
#define PYTE_MSG_DONTWAIT ...
#define PYTE_MSG_WAITALL ...
#define PYTE_MSG_NOSIGNAL ...
#define PYTE_MSG_TRUNC ...
#define PYTE_MSG_CTRUNC ...
#define PYTE_MSG_ERRQUEUE ...
#define PYTE_MSG_MCAST ...
#define PYTE_MSG_BCAST ...
#define PYTE_MSG_MORE ...
#define PYTE_MSG_CONFIRM ...
#define PYTE_MSG_EOR ...
#define PYTE_ECONNREFUSED ...
#define PYTE_ENOENT ...
#define PYTE_ENODATA ...
#define PYTE_EPERM ...
#define PYTE_ENOPROTOOPT ...
...
#define PYTE_MI_MEAS_TIME ...
#define PYTE_MI_MEAS_LOADAVG ...
#define PYTE_MI_MEAS_CPS ...
#define PYTE_MI_MEAS_PPS ...
#define PYTE_MI_MEAS_EPE ...
#define PYTE_MI_MEAS_UNITLESS_VALUE ...
...
/* MI view type and graph axis constants */
#define PYTE_MI_VIEW_LINE_GRAPH ...
#define PYTE_MI_GRAPH_AXIS_X ...
#define PYTE_MI_GRAPH_AXIS_Y ...
