...
**Fixture provenance:**::
        ...
        lib/pyte/tests/data/fio_sample.json was generated by running fio
        directly on host ``test`` (passwordless SSH):
        ...
        fio version: fio-3.39.  The JSON paths and value types are pinned
        from this real output, not from hand-rolled samples.
"""
